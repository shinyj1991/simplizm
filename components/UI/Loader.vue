...
.loader {position: fixed; top: 0; right: 0; bottom: 0; left: 0; z-index: 9999; background: rgba(255, 255, 255, 0.5); display: flex; justify-content: center; align-items: center;
  .spinner {position: relative; width: 70px; height: 65px;
    div {position: absolute; width: 20px; height: 20px; border-radius: 50%; background: #0f4f7d; animation: loading_spinner 1s linear infinite;
